...
export type FieldPolicy<
  ...
  // The type of the options sent as the last argument of read and merge
  // functions. Must extends FieldFunctionOptions generic.
...
export type FieldReadFunction<TExisting = any, TReadResult = TExisting, TOptions extends FieldFunctionOptions = FieldFunctionOptions> = (
...
export type FieldMergeFunction<TExisting = any, TIncoming = TExisting, TOptions extends FieldFunctionOptions = FieldFunctionOptions> = (
  existing: SafeReadonly<TExisting> | undefined,
